...
class Property extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'plot_grz' => 'decimal:2',
            'plot_bmz' => 'decimal:2',
            'plot_max_building_area' => 'decimal:2',
            'plot_max_units_per_building' => 'integer',
            'plot_max_height_first' => 'decimal:2',
            'plot_max_height_eaves' => 'decimal:2',
            'plot_max_length' => 'decimal:2',
            'plot_max_width' => 'decimal:2',
            'plot_min_roof_pitch' => 'decimal:1',
            'plot_max_roof_pitch' => 'decimal:1',
            'plot_utility_water' => 'boolean',
            'plot_utility_sewage' => 'boolean',
            'plot_utility_electricity' => 'boolean',
            'plot_utility_gas' => 'boolean',
            'plot_utility_fiber' => 'boolean',
            'plot_wlv_reserve' => 'boolean',
            'plot_wlv_hint' => 'boolean',
            'plot_flood_risk' => 'boolean',
            'plot_landscape_protection' => 'boolean',
            'plot_planting_obligation' => 'boolean',
