...
- KEINE Markdown-Formatierung! Kein **fett**, kein *kursiv*, keine # Überschriften, keine Listen mit - oder *. Schreibe reinen Fließtext wie in einer normalen E-Mail.{$styleFeedback}";
        ...
        if ($isErstanfrage) {
            if ($hasExpose) {
                $erstanfrageHint = "\n\n========================\nERSTANFRAGE MIT EXPOSÉ\n========================\nDies ist eine ERSTANFRAGE und ein Exposé ist vorhanden. Das System hängt UNTEN in der Mail in einem separaten Satz einen Freigabe-LINK an. Du formulierst deinen Mail-Body so, dass dieser Link der eindeutige Bezugspunkt ist.\n\nPFLICHT-FORMULIERUNG\nVerwende für den Hinweis auf den Link wortwörtlich oder eng angelehnt eine dieser Varianten:\n  - „Im unten angefügten Link finden Sie alle wichtigen Informationen zum Objekt.\"\n  - „Im unten angefügten Link finden Sie das Exposé sowie alle weiteren Unterlagen.\"\n  - „Über den unten angefügten Link gelangen Sie zum Exposé und zu allen weiteren Unterlagen.\"\nDas Schlüsselwort ist 'unten angefügten Link' (Singular). NICHT 'Links', NICHT 'unter folgendem Link', NICHT 'beiliegender Link'.\n\nABSOLUTES VERBOT (jegliche Wortform / Deklination)\nFolgende Begriffe und alle ihre flexionellen Varianten dürfen im Body NICHT vorkommen:\n  - anbei / im Anhang / als Anhang / Anlage\n  - beigefügt / beigefügtem / beigefügten / beigefügter / beigefügte / beigefügtes\n  - beigelegt / beigelegtem / beigelegten / beigelegter / beigelegte / beigelegtes\n  - beiliegend / beiliegendem / beiliegenden / beiliegender / beiliegende / beiliegendes\n  - mitgesendet / mitgeschickt / mitgegeben / mitgeliefert\n  - 'wird/werden mitgesendet', 'wird/werden mitgeschickt', 'wird angehängt', 'als PDF im Anhang'\nKEIN Hinweis darauf, dass etwas als Datei/Anhang mitgesendet wird. KEIN Erfinden einer URL — der Link wird vom System eingefügt.\n\nAntwort-Struktur (3-4 kurze Sätze):\n1. Höfliche Anrede + Dank für die Anfrage zur Immobilie (Adresse / Projektname nennen).\n2. Pflicht-Formulierung mit 'unten angefügten Link' (siehe oben).\n3. FALLS spezifische Fragen in der Anfrage stehen (Zimmer, Verfügbarkeit, Heizung, etc.) → kurz und sachlich beantworten mit Fakten aus Objektdaten/Wissensdatenbank.\n4. Knapper Schluss (z.B. Angebot für Rückfragen / Beratungsgespräch).\n\nKEINE langen Beschreibungen, KEIN Marketing-Text, NICHTS dazu dichten. Halte die Antwort so knapp wie möglich.\n";
            }
