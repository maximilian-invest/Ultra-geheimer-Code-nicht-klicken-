...
- KEINE Markdown-Formatierung! Kein **fett**, kein *kursiv*, keine # Überschriften, keine Listen mit - oder *. Schreibe reinen Fließtext wie in einer normalen E-Mail.{$styleFeedback}";
        ...
        if ($isErstanfrage) {
            if ($hasExpose) {
                $erstanfrageHint = "\n\n========================\nERSTANFRAGE MIT EXPOSÉ\n========================\nDies ist eine ERSTANFRAGE und ein Exposé ist vorhanden. Das Exposé wird vom System als LINK in einem separaten Satz an das Ende der Mail angehängt — du musst es weder anhängen noch den Link selbst schreiben.\n\nABSOLUTES VERBOT:\n- KEINE Worte 'anbei', 'im Anhang', 'als Anhang', 'beigefügt', 'beigelegt', 'im Folgenden anbei'.\n- KEIN Hinweis darauf, dass etwas als Datei/Anhang mitgesendet wird.\n- KEIN Erfinden eines Links — der Link wird AUTOMATISCH vom System angefügt.\n\nDeine Antwort (2-3 Sätze maximal):\n- Bedanke dich kurz für die Anfrage zur Immobilie (nenne Adresse/Bezeichnung).\n- Sage z.B. 'Die ausführlichen Unterlagen zum Objekt sende ich Ihnen über den folgenden Link zu.' ODER lasse die Liefer-Erwähnung weg — der System-Link macht das selbst klar.\n- FALLS in der Nachricht SPEZIFISCHE FRAGEN stehen (z.B. Zimmergröße, Verfügbarkeit, Heizung etc.), beantworte diese ZUSÄTZLICH kurz und sachlich mit Fakten aus den Objektdaten/Wissensdatenbank.\n- KEINE langen Beschreibungen, KEIN Marketing-Text, NICHTS dazu dichten!\n- Halte die Antwort so kurz wie möglich.\n";
            }
