            ...
            <div v-else-if="property" class="space-y-6">
              ...
              <div v-show="steps[wizardStep]?.key === 'basis'" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-5">
                  ...
                  <div class="bg-white border border-zinc-200/80 rounded-2xl p-6 space-y-4">
                    <h3 class="text-sm font-semibold text-zinc-900 uppercase tracking-wider">Makler</h3>
                    <div>
                      <label class="block text-xs font-medium text-zinc-500 mb-1.5">Zustaendiger Makler</label>
                      <select v-model="property.broker_id" class="w-full px-3 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-zinc-900/10 focus:bg-white transition-all">
