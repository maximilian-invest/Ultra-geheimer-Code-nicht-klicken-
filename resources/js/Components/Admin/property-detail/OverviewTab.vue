...
<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
      <!-- Kaufpreis -->
      <div class="rounded-lg px-4 py-3" style="border:1px solid hsl(240 5.9% 90%);background:hsl(240 4.8% 95.9%)">
    ...
    <div>
      ...
      <div class="rounded-lg overflow-hidden" style="border:1px solid hsl(240 5.9% 90%)">
        <div class="grid grid-cols-[110px_1fr] sm:grid-cols-[130px_1fr_130px_1fr]">
          ...
          <!-- Row: Straße / PLZ+Ort -->
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">Straße</div>
          <div class="px-3 py-2 text-[12px]" style="color:hsl(240 10% 3.9%);border-bottom:1px solid hsl(240 5.9% 90%);border-right:1px solid hsl(240 5.9% 90%)">{{ property.address || '–' }}</div>
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">PLZ / Ort</div>
          ...
          <!-- Row: Fläche / Typ -->
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">Fläche</div>
          <div class="px-3 py-2 text-[12px]" style="color:hsl(240 10% 3.9%);border-bottom:1px solid hsl(240 5.9% 90%);border-right:1px solid hsl(240 5.9% 90%)">
          ...
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">Objekttyp</div>
          <div class="px-3 py-2 text-[12px]" style="color:hsl(240 10% 3.9%);border-bottom:1px solid hsl(240 5.9% 90%)">{{ property.object_type || '–' }}</div>

          <!-- Row: Heizung / Aufzug -->
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">Heizung</div>
          <div class="px-3 py-2 text-[12px]" style="color:hsl(240 10% 3.9%);border-bottom:1px solid hsl(240 5.9% 90%);border-right:1px solid hsl(240 5.9% 90%)">{{ property.heating || property.heating_type || '–' }}</div>
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">Aufzug</div>
          ...
          <!-- Row: HWB / Stockwerke -->
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">HWB</div>
          <div class="px-3 py-2 text-[12px]" style="color:hsl(240 10% 3.9%);border-bottom:1px solid hsl(240 5.9% 90%);border-right:1px solid hsl(240 5.9% 90%)">
          ...
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-bottom:1px solid hsl(240 5.9% 90%)">Stockwerke</div>
          ...
          <div class="px-3 py-2 text-[11px] font-medium" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);" :class="!isNewbuild ? 'border-bottom:1px solid hsl(240 5.9% 90%)' : ''">Stellplätze</div>
          <div class="px-3 py-2 text-[12px]" style="color:hsl(240 10% 3.9%);border-right:1px solid hsl(240 5.9% 90%)" :style="!isNewbuild ? 'border-bottom:1px solid hsl(240 5.9% 90%)' : ''">{{ property.parking_spaces || '–' }}</div>
          ...
          <template v-if="isNewbuild">
            <div class="px-3 py-2 text-[11px] font-medium border-t" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-color:hsl(240 5.9% 90%);border-bottom:1px solid hsl(240 5.9% 90%)">Bauträger</div>
            <div class="px-3 py-2 text-[12px] border-t border-b" style="color:hsl(240 10% 3.9%);border-color:hsl(240 5.9% 90%);border-right:1px solid hsl(240 5.9% 90%)">{{ property.builder_company || '–' }}</div>
            <div class="px-3 py-2 text-[11px] font-medium border-t" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-color:hsl(240 5.9% 90%);border-bottom:1px solid hsl(240 5.9% 90%)">Fertigstellung</div>
          ...
          <template v-if="!isNewbuild">
            <div class="px-3 py-2 text-[11px] font-medium border-t" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-color:hsl(240 5.9% 90%);border-bottom:1px solid hsl(240 5.9% 90%)">Baujahr</div>
            <div class="px-3 py-2 text-[12px] border-t border-b" style="color:hsl(240 10% 3.9%);border-color:hsl(240 5.9% 90%);border-right:1px solid hsl(240 5.9% 90%)">{{ property.construction_year || '–' }}</div>
            <div class="px-3 py-2 text-[11px] font-medium border-t" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-color:hsl(240 5.9% 90%);border-bottom:1px solid hsl(240 5.9% 90%)">Zimmer</div>
            ...
            <div class="px-3 py-2 text-[11px] font-medium border-t" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-color:hsl(240 5.9% 90%);border-bottom:1px solid hsl(240 5.9% 90%)">Zustand</div>
            <div class="px-3 py-2 text-[12px] border-t border-b" style="color:hsl(240 10% 3.9%);border-color:hsl(240 5.9% 90%);border-right:1px solid hsl(240 5.9% 90%)">{{ property.realty_condition || property.condition || '–' }}</div>
            <div class="px-3 py-2 text-[11px] font-medium border-t" style="color:hsl(240 3.8% 46.1%);background:hsl(240 4.8% 95.9%);border-color:hsl(240 5.9% 90%)">Grundstück</div>
    ...
    <div>
      ...
      <div class="rounded-lg p-4" style="border:1px solid hsl(240 5.9% 90%)">
        ...
        <div v-else class="space-y-3">
          ...
          <!-- New owner form -->
          <div v-if="showCreateOwnerForm" class="p-3.5 rounded-lg space-y-2.5" style="background:hsl(240 4.8% 95.9%);border:1px solid hsl(240 5.9% 90%)">
    ...
    <div v-if="!property.parent_id">
      ...
      <div class="rounded-lg p-4" style="border:1px solid hsl(240 5.9% 90%)">
        ...
        <div v-else class="space-y-3">
          ...
          <!-- Create portal form -->
          <div v-else class="p-3.5 rounded-lg space-y-2.5" style="background:hsl(240 4.8% 95.9%);border:1px solid hsl(240 5.9% 90%)">
  ...
  <Teleport to="body">
        ...
        <div class="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <select :value="property.project_group_id || ''"
              ...
              class="w-full px-3 py-2.5 rounded-xl text-[13px] focus:outline-none focus:ring-2" style="background:hsl(240 4.8% 95.9%);border:1px solid hsl(240 5.9% 90%);color:hsl(240 10% 3.9%)">
    ...
    <div v-if="childCreateModal" class="fixed inset-0 z-[320] flex items-center justify-center" style="background:rgba(0,0,0,0.4);backdrop-filter:blur(4px)">
      <div class="relative w-[480px] max-w-[calc(100vw-2rem)] rounded-2xl shadow-2xl overflow-hidden bg-white" style="border:1px solid hsl(240 5.9% 90%)">
        ...
        <div v-if="childMode === 'categories'" class="px-5 py-4">
          ...
          <div v-else class="space-y-2">
            <div v-for="cat in childCategories" :key="cat.rooms"
              ...
              :style="childSelected.has(cat.rooms) ? 'background:rgba(99,102,241,0.06);border:1.5px solid #6366f1' : 'background:hsl(240 4.8% 95.9%);border:1.5px solid hsl(240 5.9% 90%)'">
        ...
        <!-- Footer -->
        <div class="flex justify-end gap-2 px-5 py-3" style="border-top:1px solid hsl(240 5.9% 90%);background:hsl(240 4.8% 95.9%)">
