...
import {
    ...
    ChevronsLeft, Calendar, X, CheckCircle, Bell, Users, AlertTriangle, Inbox as InboxIcon, Clock as ClockIcon, Sparkles, Home as HomeIcon, Menu, Globe, ListTodo
...
async function loadCounts() {
    ...
    // Load open task count for sidebar badge
    try {
        const isAss = ['assistenz','backoffice'].includes(userType.value);
        const tUrl = apiBase + '&action=getTasks' + (isAss ? '&scope=assistenz' : '');
